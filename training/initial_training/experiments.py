...
class ExperimentLogger:
    def __init__(self, log_file):
        ...
        self.fieldnames = [
            'exp_id', 'date', 'input_size', 'augmentation', 'sample_ratio',
            'lr', 'batch_size', 'epochs', 
            'total_time', 'mode', 'error','exp_dir', 
            'train_loss', 'val_loss', 'test_loss', 
            'train_acc', 'val_acc', 'test_acc',
            'mnist_acc', 'emnist_acc', 'svhn_acc'
        ]
    ...
    def log(self, args, results, exp_id=None):
        ...
        row = {
            ...
            'mnist_acc': results.get('mnist_acc'),
            'emnist_acc': results.get('emnist_acc'),
            'svhn_acc': results.get('svhn_acc'), 
        }
        for _ in range(3):
            try:
